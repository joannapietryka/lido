  ...
  return (
    <>
      <div className="flex flex-col lg:flex-row justify-between items-end gap-12 mb-16">
        <h1 className="text-[64px] lg:text-[88px] leading-[0.95] font-light tracking-[-0.02em] lg:w-2/3">
        Twój nowy adres  <br />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-auto lg:h-[550px]">
        <div className="col-span-1 lg:col-span-5 rounded-[2.5rem] relative overflow-hidden group h-[400px] lg:h-full">
          <img
        ...
        <div className="col-span-1 lg:col-span-7 flex flex-col gap-6 h-full">
          <div className="relative rounded-[2.5rem] overflow-hidden group h-[240px] lg:h-[250px]">
            <video
              src={heroVideo}
              className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105"
              autoPlay
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 h-[300px] lg:h-[270px]">
            <div className="rounded-[2.5rem] overflow-hidden group h-full">
              <img
            ...
            <div className="bg-[#EBEBEB] rounded-[2.5rem] p-8 flex flex-col justify-center relative h-full">
